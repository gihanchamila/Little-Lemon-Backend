...
class ModelTests(TestCase):
    ...
    setUpTestData runs once per class, which is efficient.
    """
    @classmethod
    ...
    def test_custom_user_model(self):
        ...
        self.assertTrue(user.is_active) # From AbstractUser
...
class BookingRelationshipTests(TestCase):
    ...
    def test_booking_creation_and_defaults(self):
        ...
        self.assertIn('Booking for testuser', str(self.booking))
...
class PaymentRelationshipTests(TestCase):
    ...
    def test_booking_deletion_cascades_to_payment(self):
        ...
        Payment.objects.create(booking=self.booking, user=self.user, amount=1)
        self.assertEqual(Payment.objects.count(), 1)
        self.booking.delete()
